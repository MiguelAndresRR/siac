    ...
    <div class="container">
        ...
        <div class="content-productos">
            ...
            <div class="registrar-producto-container">
                ...
                <form action="{{ route('admin.productos') }}" method="POST">
                    @csrf
                    <i class="fa-solid fa-box"></i>
                    <label> Nombre del producto</label><br>
                    <input type="text" class="form-control" id="nombre_producto" name="nombre_producto"
                        value="{{ old('nombre_producto') }}" placeholder="Nombre del producto" required><br>
                    <i class="fa-sharp fa-solid fa-coins" style="color: #FFD43B;"></i>
                    ...
                    <i class="fa-sharp fa-solid fa-layer-group" style="color: #ff0000;"></i></label>
                    ...
                    <i class="fa-solid fa-scale-balanced" style="color: #04fb56;"></i>
